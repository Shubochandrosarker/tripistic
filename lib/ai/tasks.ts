...
export const TASK_PROFILES: Record<AiTask, TaskProfile> = {
  fast_chat: {
    task: "fast_chat",
    preferredModels: ["openrouter/openai/gpt-4o-mini", "groq/openai/gpt-oss-120b", "groq/llama-3.3-70b-versatile", "openai/gpt-4o-mini"],
  ...
  website_generation: {
    ...
    preferredModels: ["openrouter/openai/gpt-4o", "groq/openai/gpt-oss-120b", "groq/llama-3.3-70b-versatile", "openai/gpt-4o"],
  ...
  classification: {
    task: "classification",
    preferredModels: ["openrouter/openai/gpt-4o-mini", "groq/openai/gpt-oss-20b", "groq/llama-3.1-8b-instant", "openai/gpt-4o-mini"],
