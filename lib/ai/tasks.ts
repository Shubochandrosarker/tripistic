...
export const TASK_PROFILES: Record<AiTask, TaskProfile> = {
  fast_chat: {
    task: "fast_chat",
    preferredModels: ["workers-ai/@cf/meta/llama-3.1-8b-instruct", "openai/gpt-4o-mini"],
  ...
  rag_answer: {
    task: "rag_answer",
    preferredModels: ["openai/gpt-4o-mini", "workers-ai/@cf/meta/llama-3.1-8b-instruct"],
  ...
  website_generation: {
    ...
    preferredModels: ["openai/gpt-4o", "openai/gpt-4o-mini"],
